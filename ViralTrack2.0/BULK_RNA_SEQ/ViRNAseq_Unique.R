...
featurecommand = paste("featureCounts -t transcript -g gene_id -T ", N_thread, " -a ", path_to_gtf, " -o ", temp_output_dir, "/counts.txt -p -s 0 " , feature_count_path, " 2> ", name_prefix, "_FEATURE_COUNTS.log", sep="")
